const SYMBOL_GROUPS = [
  { name: 'Punctuation & Brackets', scale: 1.2, symbols: ['$','#','@','%','&','*','+','~','ʌ','!','?','<','>','§','Ω','»','¶','«','¿','£','=','¢'] },
  ...
  { name: 'Runes', scale: 1.2, symbols: ['\u16a0','\u16a1','\u16a2','\u16a3','\u16a4','\u16a5','\u16a6','\u16a7','\u16a8','\u16a9','\u16aa','\u16ab','\u16ac','\u16ad','\u16ae','\u16af','\u16b0','\u16b1','\u16de','\u16b3','\u16b4','\u16b5'] },
];
...
const REWARD_LEVELS = GAME_CONFIG.rewardLevels || [
  ...
  { threshold: 75,  phrase: "You've raisined the stakes!",               label: "Stake Raiser" },
  ...
  { threshold: 200, phrase: "You've totally raised the bar!",            label: "Bar Raiser" },
  { threshold: 250, phrase: "You're raisin eyebrows all over!",          label: "Eyebrow Raiser" },
  { threshold: 300, phrase: "You really raise and shine!",               label: "Raisin Shine" },
  { threshold: 350, phrase: "You're off the raisin charts!",             label: "Chart Raiser" },
  { threshold: 400, phrase: "You're really, really raisy!",              label: "Really Raisy" },
  { threshold: 450, phrase: "You're raisin the roof!",                   label: "Roof Raiser" },
  { threshold: 500, phrase: "Hip hip hurraisin!",                        label: "Hurraisin" },
  { threshold: 600, phrase: "You're at the edge of raisin!",             label: "Edge of Raisin" },
